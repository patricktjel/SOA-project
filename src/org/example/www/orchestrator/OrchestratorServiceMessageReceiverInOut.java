...
/**
 * OrchestratorServiceMessageReceiverInOut.java
 *
 ...
 */
        ...
        /**
        *  OrchestratorServiceMessageReceiverInOut message receiver
        */

        public class OrchestratorServiceMessageReceiverInOut extends org.apache.axis2.receivers.AbstractInOutMessageReceiver{
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("rentIceSkates".equals(methodName)){
                
                org.example.www.orchestrator.RentIceSkatesResponse rentIceSkatesResponse15 = null;
	                        org.example.www.orchestrator.RentIceSkates wrappedParam =
                                                             (org.example.www.orchestrator.RentIceSkates)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    org.example.www.orchestrator.RentIceSkates.class,
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                                
                                               rentIceSkatesResponse15 =
                                                   
                                                   
                                                         skel.rentIceSkates(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), rentIceSkatesResponse15, false, new javax.xml.namespace.QName("http://www.example.org/orchestrator",
                                                    "rentIceSkates"));
