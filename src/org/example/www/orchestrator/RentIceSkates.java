 ...
 */
            ...
            /**
            *  RentIceSkates bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RentIceSkates
    ...
    public static class Factory{
        ...
        */
        public static RentIceSkates parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RentIceSkates object =
                new RentIceSkates();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"rentIceSkates".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RentIceSkates)org.example.www.orchestrator.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
