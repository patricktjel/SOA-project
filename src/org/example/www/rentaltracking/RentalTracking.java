...
public class RentalTracking implements org.apache.axis2.databinding.ADBBean {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			java.lang.String namespacePrefix = registerPrefix(xmlWriter, "http://www.example.org/rentalTracking");
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":rentalTracking", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "rentalTracking", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 */
		public static RentalTracking parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			RentalTracking object = new RentalTracking();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"rentalTracking".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (RentalTracking) org.example.www.rentaltracking.ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
