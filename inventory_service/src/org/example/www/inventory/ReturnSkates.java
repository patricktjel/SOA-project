...
public class ReturnSkates implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://www.example.org/inventory", "returnSkates", "ns3");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":returnSkates", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "returnSkates", xmlWriter);
			}
	...
	public static class Factory {
		...
		public static ReturnSkates parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			ReturnSkates object = new ReturnSkates();
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"returnSkates".equals(type)) {
							...
							return (ReturnSkates) org.example.www.inventory.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
