 ...
 */
        ...
        */
        ...
        InventoryServiceSkeletonInterface skel = (InventoryServiceSkeletonInterface)obj;
        //Out Envelop
        ...
        //
            ...
            throws org.apache.axis2.AxisFault {
                        ...
                        try{
                             return param.getOMElement(org.example.www.inventory.Inventory.MY_QNAME,
                                          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
                        } catch(org.apache.axis2.databinding.ADBException e){
                            throw org.apache.axis2.AxisFault.makeFault(e);
                        }
            ...
            private  org.apache.axiom.om.OMElement  toOM(org.example.www.inventory.InventoryResponse param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(org.example.www.inventory.InventoryResponse.MY_QNAME,
                                          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
                        } catch(org.apache.axis2.databinding.ADBException e){
                            throw org.apache.axis2.AxisFault.makeFault(e);
                        }
                    ...
                    private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, org.example.www.inventory.InventoryResponse param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                      ...
                      try{
                          org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                                    ...
                                    emptyEnvelope.getBody().addChild(param.getOMElement(org.example.www.inventory.InventoryResponse.MY_QNAME,factory));
                        ...
                        throw org.apache.axis2.AxisFault.makeFault(e);
                         ...
                         private org.example.www.inventory.InventoryResponse wrapinventory(){
                                org.example.www.inventory.InventoryResponse wrappedElement = new org.example.www.inventory.InventoryResponse();
                                return wrappedElement;
                         }
        ...
        */
        ...
        try {
                ...
                if (org.example.www.inventory.Inventory.class.equals(type)){
                
                        return org.example.www.inventory.Inventory.Factory.parse(param.getXMLStreamReaderWithoutCaching());
